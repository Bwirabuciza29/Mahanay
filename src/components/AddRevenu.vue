<template>
  <q-layout view="hHh LpR fFf">
    <q-header reveal bordered class="bg-white text-dark q-pa-md">
      <q-toolbar>
    ...
    <q-page-container>
      <div class="q-pa-md">
        <q-card class="my-card" flat bordered>
          <q-card-section>
            <div class="text-h6">Produits Achetés</div>
            <div class="text-subtitle2">hmaanay</div>
          </q-card-section>
          ...
          <q-markup-table>
            ...
            <tbody>
              <tr>
                ...
                <td class="text-right">Maillot H</td>
                <td class="text-right">83 usd</td>
                <td class="text-right">
                  <q-btn
                    flat
                    icon="fa-solid fa-eye fa-beat"
                    color="grey"
                    @click="card = true"
                  />
                </td>
                <td class="text-right">June 1 2023</td>
                <td class="text-right">
                  <q-btn
                    flat
      ...
      <q-toolbar>
        <q-toolbar-title>
          ...
          <div class="menu" align="center">
            ...
            <router-link to="/Revenu" class="icon">
              <q-btn
                class="icon"
                round
                flat
            ...
            <router-link to="/RapportsLivreur" class="icon">
              <q-btn
                class="icon"
                style="color: aqua"
                round
  ...
  <q-dialog v-model="card">
    <q-card class="my-card">
      <q-img src=~assets/2.jpg />

      <q-card-section> </q-card-section>

      <q-card-section class="q-pt-none">
        <div class="text-subtitle1">Manchester City</div>
  ...
  <q-dialog v-model="toolbar">
    <q-card>
      <q-toolbar>
        <q-avatar>
          <img src="~assets/aigle.jpg" />
        </q-avatar>

        <q-toolbar-title
          ><span class="text-weight-bold">hibaigle</span>
          Assistance</q-toolbar-title
        >
...
export default defineComponent({
  name: "IndexPage",
  components: { chartExample, ButtonAdd },
