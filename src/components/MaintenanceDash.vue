        ...
        <q-markup-table>
          <thead>
            <tr>
              ...
              <th class="text-center">Description Panne</th>
          ...
          <tbody>
            <tr>
              ...
              <td class="text-center">
                <div class="text-red" style="font-size: 2em">
                <q-icon name="fingerprint" @click="persistent = true" />
                </div>
              </td>
              <td class="text-center">
                      <div class="q-gutter-md" style="font-size: 2em">
                        <q-icon name="verified_user" class="text-green" />
...
<!-- FIN DIALOGUE  IMAGE-->
    ...
    <!-- DIALOGUE DESCRIPTION -->
        ...
        <q-card class="bg-teal text-white" style="width: 300px">
          <q-card-section>
            <div class="text-h6">Panne 001</div>
          </q-card-section>

          <q-card-section class="q-pt-none">
            <p class="text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga quibusdam numquam sunt quod, perspiciatis deleniti sint blanditiis architecto magnam perferendis laboriosam, enim eum earum, molestiae nobis ullam eveniet dolorum quaerat!</p>
          </q-card-section>
