    ...
    <q-drawer show-if-above v-model="leftDrawerOpen" side="left" elevated>
      ...
      <div class="q-pa-md" style="max-width: 350px">
        ...
        <q-list bordered class="rounded-borders">
          <router-link to="/Livreur" class="dash">
            <q-expansion-item
              switch-toggle-side
              expand-separator
          ...
          <router-link to="/DiscussionMessage" class="dash">
            <q-expansion-item
              switch-toggle-side
              expand-separator
        ...
        <q-list bordered class="rounded-borders q-mt-md">
          <router-link to="/RapportsLivreur" class="dash">
            <q-expansion-item
              dense-toggle
              switch-toggle-side
              expand-separator
      ...
      <q-toolbar>
        <q-toolbar-title>
          ...
          <div class="menu" align="center">
            ...
            <router-link to="/Livreur" class="icon">
              <q-btn
                class="icon"
                round
                flat
...
import TabRapports from "./TabRapports.vue";

export default {
  components: { DialogPage, TablePanier, TabRapports },
